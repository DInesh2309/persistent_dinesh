...
<div id="container">
	...
	<div id="body">
            <form autocomplete="off" role="form" class="form-horizontal" action="<?php echo base_url() ?>Home/uploadCSVData" role="form" name="addEvent" id="addEvent" enctype="multipart/form-data"  method="post">
		<div class="col-lg-4 mb-2">
                    <div class="mb-4">
                        <label class="text-label form-label">Attach File </label>
